    ...
    oldMember.guild.fetchAuditLogs().then(logs => {
        ...
        if(oldMember.roles.size < newMember.roles.size) {
          ...
          onoff: 'Off'
            ...
            .setTitle('**تم اضافة رتبة الى العضو**')
        ...
        if(oldMember.roles.size > newMember.roles.size) {
          ...
          onoff: 'Off'
            ...
            .setTitle('**تم ازالة رتبة من العضو**')
            .setThumbnail(oldMember.guild.iconURL)
            .setColor('RED')
